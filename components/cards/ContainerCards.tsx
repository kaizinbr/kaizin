    ...
    return (
        ...
        >
            <div className="absolute w-full top-0 h-auto flex flex-wrap -z-10 invisible">
                {/* <div className="bg-red-600/20  w-full md:w-1/2 h-[400px] cont"></div>
                <div className="bg-red-600/20  w-full md:w-1/2 h-[400px] cont"></div>
                <div className="bg-red-600/20  w-full md:w-1/2 h-[400px] cont"></div>
                <div className="bg-red-600/20  w-full md:w-1/2 h-[400px] cont"></div>
                <div className="bg-red-600/20  w-full md:w-1/2 h-[400px] cont"></div>
            ...
            {cards.map((card, index) => (
                <div key={index} className="bg-red-600/20  w-full md:w-1/2 h-[400px] cont"></div>
            ))}
            </div>
            ...
            {/* <div className="bg-gray-500 w-full md:w-[calc(50%-16px)] md:mx-2 h-8 box flex justify-center items-center"></div>
            <div className="bg-gray-500 w-full md:w-[calc(50%-16px)] md:mx-2 h-8 box flex justify-center items-center"></div>
            <div className="bg-gray-500 w-full md:w-[calc(50%-16px)] md:mx-2 h-8 box flex justify-center items-center"></div>
            <div className="bg-gray-500 w-full md:w-[calc(50%-16px)] md:mx-2 h-8 box flex justify-center items-center"></div>
            <div className="bg-gray-500 w-full md:w-[calc(50%-16px)] md:mx-2 h-8 box flex justify-center items-center"></div>
            ...
            <div className="bg-gray-500 w-full md:w-[calc(50%-16px)] md:mx-2 h-8 box flex justify-center items-center"></div>
            <div className="bg-gray-500 w-full md:w-[calc(50%-16px)] md:mx-2 h-8 box flex justify-center items-center"></div> */}
            {/* <div className="bg-gray-500 w-full h-8 box flex justify-center items-center"></div>
            <div className="bg-gray-500 w-full h-8 box flex justify-center items-center"></div>
            <div className="bg-gray-500 w-full h-8 box flex justify-center items-center"></div>
            <div className="bg-gray-500 w-full h-8 box flex justify-center items-center"></div>
            <div className="bg-gray-500 w-full h-8 box flex justify-center items-center"></div>
